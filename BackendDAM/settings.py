"""
Django settings for BackendDAM project.
...
SECRET_KEY = 'django-insecure-+u%$k8z4b4tu176@h$-mlq8i1_$*!23ez&m^#bj5v7)@=wyk+f'
...
DATABASES = {
    'default': {
        'ENGINE': 'django-mssql-backend',  # use 'mssql' with mssql-django
        'NAME': "DB-DAM",
        'USER': "sa",
        'PASSWORD': "Bc@f2020++",
        'HOST': "192.168.1.21",
